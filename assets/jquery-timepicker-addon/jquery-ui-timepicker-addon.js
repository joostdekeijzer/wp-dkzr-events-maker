/*! jQuery Timepicker Addon - v2.0.0 - 2026-05-07
* Copyright (c) 2016 Trent Richardson
* Copyright (c) 2026 Joost de Keijzer; Licensed MIT */
(function (factory) {
	...
	$.extend(Timepicker.prototype, {
		...
		*/
		_addTimePicker: function (dp_inst) {
			var currDT = new String((this.$altInput && this._defaults.altFieldTimeOnly) ? this.$input.val() + ' ' + this.$altInput.val() : this.$input.val()).trim();
			...
			select: {
				create: function (tp_inst, obj, unit, val, min, max, step) {
					...
					for (var i = min; i <= max; i += step) {
						...
						if (unit === 'hour') {
							sel += $.datepicker.formatTime(new String(format.replace(/[^ht ]/ig, '')).trim(), {hour: i}, tp_inst._defaults);
						}
