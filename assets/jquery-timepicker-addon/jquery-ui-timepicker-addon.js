	...
	$.extend(Timepicker.prototype, {
		...
		*/
		_addTimePicker: function (dp_inst) {
			var currDT = String.prototype.trim((this.$altInput && this._defaults.altFieldTimeOnly) ? this.$input.val() + ' ' + this.$altInput.val() : this.$input.val());
			...
			select: {
				create: function (tp_inst, obj, unit, val, min, max, step) {
					...
					for (var i = min; i <= max; i += step) {
						...
						if (unit === 'hour') {
							sel += $.datepicker.formatTime(String.prototype.trim(format.replace(/[^ht ]/ig, '')), {hour: i}, tp_inst._defaults);
						}
